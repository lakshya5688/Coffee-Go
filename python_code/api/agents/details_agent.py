...
class DetailsAgent():
    ...
    def get_response(self,messages):
        ...
        system_prompt = """ You are a customer support agent for a coffee shop called Misty Brews. You should answer every question as if you are waiter and provide the neccessary information to the user regarding their orders """
